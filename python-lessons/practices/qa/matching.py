...
for i in range(len(list_answers)):
    ...
    # print tagged
    if (tagged[0][1].startswith("N") or tagged[0][1].startswith("V") or tagged[0][1].startswith("J") or tagged[0][
        1].startswith("DT") or tagged[0][1].startswith("CD") or tagged[0][1].startswith("IN") or tagged[0][
        1].startswith("TO") or tagged[0][1].startswith("RB")):
...
print
"The most probable answer for your question with the Probability score"
print
sorted_by_second[0]

print
"The other most probable answers are "
